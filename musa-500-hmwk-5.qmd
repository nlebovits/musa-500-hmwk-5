...
```{r scree plot and criteria,  results='hide', fig.keep='all'}
...
```{r aggregated value,  results='hide', fig.keep='all'}
...
```{r Spatial Distribution of Clusters, results='hide', fig.keep='all'}
